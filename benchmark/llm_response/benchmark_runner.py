...
Usage:
    python benchmark_runner.py                          # zero-shot, Ollama
...
from config          import MODEL_KEYS, MODELS, RESULTS_DIR, FIGURES_DIR, GENERATION
...
def parse_args():
    ...
    p.add_argument("--ollama_host", default="https://samuel-submit-pattern-criterion.trycloudflare.com")
...
def main():
    ...
    # ── Setup
    samples = load_empathetic_dialogues(split=args.split, num_samples=args.num_samples)
