...
#        - Use 4 to 7 sentences and at most one concrete example.
    ...
    current_system_context = """
        ...
        - The same local model classifies the emotional tone of the text.
        - DeepFace may check captured face images during the session when facial checking is enabled.
        - Tritium TTS turns my answer into spoken audio.
        - Tritium sequence_player controls my facial expressions and nodding.
        - In this session, participant speech is transcribed into text and used for my replies.
        - Face images may be checked/saved for research when enabled, but they are not used to directly generate my spoken answer unless explicitly connected in code.
